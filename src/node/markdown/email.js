...
export default class EmailMarkdownNode extends MarkdownNode {
  ...
  attributeValue(context) {
    const childNodes = this.getChildNodes(),
          ...
          attributeValue = `mailto:${URLMarkdownNodeContent}`;

    return attributeValue;
  }

  static fromRuleNameChildNodesAndOpacity(ruleName, childNodes, opacity) { return MarkdownNode.fromRuleNameChildNodesAndOpacity(EmailMarkdownNode, ruleName, childNodes, opacity); }
}
