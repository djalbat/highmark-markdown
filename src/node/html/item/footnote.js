...
export default class FootnoteItemHTMLNode extends HTMLNode {
  ...
  static fromNothing() { return HTMLNode.fromNothing(FootnoteItemHTMLNode); }

  static fromOuterNode(outerNode) { return HTMLNode.fromOuterNode(FootnoteItemHTMLNode, outerNode); }
}
