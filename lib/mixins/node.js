...
function fromFourthLastChildNode(callback) {
    var result;
    var multiplicity = this.getMultiplicity(), fourthLastIndex = multiplicity - 2;
    this.backwardsSomeChildNode(function(childNode, index) {
...
function fromFifthLastChildNode(callback) {
    var result;
    var multiplicity = this.getMultiplicity(), fifthLastIndex = multiplicity - 2;
    this.backwardsSomeChildNode(function(childNode, index) {
